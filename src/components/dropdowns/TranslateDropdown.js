...
class TranslateDropdown extends Component {
    ...
    <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggleDropdown} className="notification-list">
                <DropdownToggle
                    ...
                    <img src={this.icons[this.state.current_icon]} alt="" />
                    <span className="pro-user-name ml-1"> <i className="mdi mdi-chevron-down"></i> </span>
                </DropdownToggle>
                <DropdownMenu className="drop-menu px-3">
                    <div className="row justify-content-center align-items-center" onClick={() => {this.changeLanguage('uz')}}>
                        <img src={uz_icon} className="language_icon mr-1" alt="user" />
                        {/* <span>UZB</span> */}
                    </div>
                    <div className="row justify-content-center align-items-center" onClick={() => {this.changeLanguage('ru')}}>
                        <img src={ru_icon} className="language_icon mr-1" alt="user" />
                        {/* <span>RUS</span> */}
                    </div>
                    <div className="row justify-content-center align-items-center" onClick={() => {this.changeLanguage('en')}}>
